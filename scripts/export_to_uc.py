...
def exec_sql2(query):
    print query
    conn_string = "host=urbancanvas.cp2xwchuariu.us-west-2.rds.amazonaws.com dbname='sandag' user='sandag' password='PASSWORD' port=5432"
    import psycopg2
...
localhost_to_urbancanvas_db('scheduled_development_events', 'public', db_config, urbancanvas_db_config, exec_sql, exec_sql2, src_table_name = 'scheduled_development_events')